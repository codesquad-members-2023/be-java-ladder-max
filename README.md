...
## 리팩토링 계획
### 1. 출력의 기능을 담당하는 Output 클래스 분리
### 2. Controller -> LadderGame으로 변경
- LadderGame의 전체를 관리하는 역할을 하는 객체
- Input,Output,Ladder,Names,Results를 가지도록 한다.
### 3. Ladder에서 Names와 Results 객체를 분리한다.
- Ladder는 Names와 Results를 모르고 radder만 알도록 한다.
